...
export const MAPS = {
  ...
  bar: {
    path: Bar_TMJ,
    start: { x: 9, y: 21 },
    npcs: [{ id: "jane", x: 4, y: 8, gid: 3428, dialogueId: "jane" },
  ...
  city: {
    ...
    npcs: [
      ...
      { id: "flower_promoter", x: 21, y: 6, gid: 106, dialogueId: "flower_promoter" },
    ],
    exits: [
  ...
  neighborhood: {
    ...
    start: { x: 5, y: 10 },
    npcs: [
      { id: "hayes", x: 5, y: 8, gid: 437, dialogueId: "hayes" },
      { id: "tim", x: 24, y: 8, gid: 451, dialogueId: "tim" },
      { id: "sam", x: 39, y: 16, gid: 438, dialogueId: "sam" },
    ],
    exits: [
  ...
  jimDonnasHouse: {
    ...
    start: { x: 5, y: 5 },
    npcs: [{ id: "jim", x: 10, y: 4, gid: 424, dialogueId: "jimDonna" },
    { id: "donna", x: 11, y: 4, gid: 439, dialogueId: "jimDonna" }
    ],
    exits: [
  ...
  johnsHouse: {
    path: JohnsHouse_TMJ,
    start: { x: 5, y: 5 },
    npcs: [{ id: "john", x: 10, y: 8, gid: 1605, dialogueId: "john" },],
    exits: [
