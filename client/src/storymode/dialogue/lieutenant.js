  ...
  nodes: {
    ...
    debrief: {
      segments: [
        ...
        { speaker: "lieutenant", text: "(sigh) This was supposed to be an easy neighborhood case, way below your pay grade. How could you screw this up?", voice: "mixed_01", requires: { flagsAny: ["mixed_end", "john_shutdown"] } },
        ...
        { speaker: "lieutenant", text: "Truth is, I had Detective Marcus keeping an eye on you during the investigation.", voice: "debrief_03" },
        ...
        { speaker: "lieutenant", text: "I have the full report right here.", voice: "debrief_04" },
        ...
        { speaker: "lieutenant", text: "(sigh) Do you have anything to say for yourself?", voice: "florist_02", requires: { flagsAny: ["john_shutdown", "accused_florist"] }, },
      ],
      choices: [
        ...
        { label: "Please just give me one more interview with John. I can fix this!", next: "game_end", requires: { flagsAll: ["bad_end","john_shutdown"] } },
    ...
    game_end: {
      segments: [
        ...
        { speaker: "lieutenant", text: "Get out of my office. You're fired.", voice: "fired", requires: { flagsAny: ["accused_florist", "accused_hayes", "john_shutdown"] } },
