const johnDialogue = {
  ...
  nodes: {
   intro: {
    segments: [
      { speaker: "john", text: "You're the detective, right? I'm John.", voice: "intro_01" }
    ],
   ...
   robbery_menu_silent: {
    segments: [],
    choices: [
      { label: "What's your take on Jim's robbery?", next: "jim_topic_menu_silent" },
      { label: "Let's talk about your missing money.", next: "john_topic_menu_silent" },

      { label: "Heard there was a big argument yesterday.", next: "fight_start", requires: { notFlags: ["asked_John_robbery"], cluesAll: ["clue_john_argument"] } },
   ...
   jim_topic_menu_silent: {
    ...
    choices: [
      ...
      { label: "Let's talk about something else.", next: "robbery_menu_silent" },
      { label: "That's enough for now.", next: "good_end" }
    ]
   },
   ...
   john_topic_menu_silent: {
    ...
    choices: [
      { label: "Why didn't you report it?", next: "no_report", requires: { notFlags: ["asked_no_report"] } },
      { label: "When did you notice the money was missing?", next: "noticed_missing_money", requires: { notFlags: ["asked_noticed_missing_money"] } },
      { label: "Did you see anyone suspicious?", next: "suspicious", requires: { notFlags: ["asked_suspicious"] } },
   ...
   john_press_01: {
    segments: [
      { speaker: "john", text: "Boy I know you ain't just say that. What a dumb thing to say", voice: "pressed_03" },
      { speaker: "john", text: "I don't see how this pertains to your investigation.", voice: "john_press_01" }
    ],
    set: { flagsAdd: ["asked_john_press_01"] },
    choices: [
      { label: "I'm just saying people usually clean when guests are coming", next: "evil_path" },
      { label: "I want to ask about how both you and Jim lost money.", next: "baseline" },
      { label: "Heard there was a big argument yesterday.", next: "fight_start", requires: {  notFlags: ["asked_John_robbery"], cluesAll: ["clue_john_argument"] } },
      { label: "That's enough for now.", next: "good_end" }
    ]
   ...
   insult: {
    ...
    choices: [
      { label: "Where were you that night?", next: "where_were_you", requires: { notFlags: ["asked_where_were_you"] } },
      { label: "Alright, let's talk about something else.", next: "robbery_menu_silent" },
      { label: "That's enough for now.", next: "good_end" }
    ]
   },
   ...
   where_were_you: {
    segments: [
      { speaker: "john", text: "I was home celebrating Jane's birthday.", voice: "where_were_you" }
    ],
   ...
   Jane: {
    ...
    choices: [
      ...
      { label: "ha what a loser its probably your fault isn't it", next: "evil_path" },
   ...
   evil_path: {
    segments: [
      { speaker: "john", text: "Are you kidding me!? What type of detective are you!?", voice: "pressed_05" },
    ...
    choices: [
      ...
      { label: "With pleasure", next: "good_end" }
    ]
   },

   time_pressure: {
    segments: [
      { speaker: "john", text: "Don't waste my time again, detective.", }
    ],
   ...
   fight_details: {
    segments: [
      { speaker: "john", text: "That's as far as you're going, detective. Stay out of it.", voice: "agurment_03" },
    ],
   ...
   good_end: {
    segments: [
      { speaker: "john", text: "Great.", voice: "great" }
    ],
